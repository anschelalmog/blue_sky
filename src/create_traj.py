...
class CreateTraj(BaseTraj):
    ...
    def _create_vel(self):
        ...
        self.vel.east = self.inits['avg_spd'] * sind(self.inits['psi']) + self.inits['acc_east'] * self.time_vec
        self.vel.down = self.inits['avg_spd'] * sind(self.inits['theta']) + self.inits['acc_down'] * self.time_vec
